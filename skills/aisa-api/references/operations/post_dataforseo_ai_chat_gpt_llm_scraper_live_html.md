# post_dataforseo_ai_chat_gpt_llm_scraper_live_html
...
```json
{
  "operation_id": "post_dataforseo_ai_chat_gpt_llm_scraper_live_html",
  "successful": true,
  ...
  "provider": "dataforseo",
  "method": "POST",
  "path": "/apis/v1/dataforseo/ai_optimization/chat_gpt/llm_scraper/live/html",
  "arguments_schema": {
    "type": "object",
    "properties": {
      "body": {
        ...
        "items": {
          ...
          "properties": {
            ...
            "expand_citations": {
              "type": "boolean",
              "description": "return expanded citation bar in HTML results optional field to enable this parameter, force_web_search must also be enabled; when enabled, the endpoint will return HTML data from the expanded citation bar; default value: false"
            },
            "tag": {
              "type": "string",
