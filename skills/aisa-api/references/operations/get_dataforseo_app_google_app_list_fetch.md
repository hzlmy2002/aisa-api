# get_dataforseo_app_google_app_list_fetch
...
```json
{
  "operation_id": "get_dataforseo_app_google_app_list_fetch",
  "successful": true,
  ...
  "provider": "dataforseo",
  "method": "GET",
  "path": "/apis/v1/dataforseo/app_data/google/app_list/task_get/advanced/{id}",
  "arguments_schema": {
    "type": "object",
    "properties": {
      "id": {
