...
- [aisa-creator-outreach-list](../../aisa-creator-outreach-list/SKILL.md) — Find similar YouTube or TikTok creators, research influencers, look up creator emails, or build a KOL outreach shortlist from a profile or campaign brief. 达人拓展、相似博主、网红名单、创作者邮箱、KOL联系表、YouTube和TikTok达人发现、Instagram邮箱查询。
- [aisa-recent-topic-research](../../aisa-recent-topic-research/SKILL.md) — Research what happened recently or what people are saying about a topic, product launch, company or competitor. Use for last-30-days research, launch reactions, recent trends and cross-source discussion briefs. 最近30天、近期动态、产品发布反响、热点趋势、竞品近况、社区反馈、舆情调研。
